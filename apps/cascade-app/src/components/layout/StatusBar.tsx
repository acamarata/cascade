 ...
 * Inputs:  useDaemonStatus (daemon state), useAccounts (fleet utilization dot color).
 * Outputs: <footer role="contentinfo"> landmark at the bottom of the app chrome.
 * Constraints:
 *   - role="contentinfo" for accessibility. Height h-6.
 *   - Fleet chip: colored dot (green/yellow/red) = worst utilization across accounts.
