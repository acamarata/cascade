/**
 * Purpose: Persist GP Chat messages in localStorage keyed by session_id.
 ...
 *   try/catch — corrupt storage yields empty array. No daemon sync in this ticket
 *   (daemon GET/POST routes are separate scope per T-P3-E02-20 guide step 4).
 * SPORT: T-P3-E02-20 useChatHistory hook
 */
...
function storageKey(sessionId: string): string {
  return `gp-chat-history-${sessionId}`
}
