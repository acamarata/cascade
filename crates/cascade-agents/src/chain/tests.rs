...
mod tests {
    ...
    use super::super::builtins::{builtin_research_summarize_draft, builtin_triage_branch_respond};
    use super::super::executor::ChainExecutor;
    use super::super::types::{ChainContext, ChainError, ChainFlow, ChainStep, ChainValidationError};
