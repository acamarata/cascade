...
// Purpose: the codex-binary detect predicate. Auto-enables cascade-codex
//   when the codex CLI is reachable in PATH; dormant, without error, when
//   it is not.
...
// SPORT: plugins/codex detect (ADD) — P1-E16-W4-S34-T3.
...
// codexBinary is the executable name Detect probes for.
...
// Detect reports whether the codex binary is reachable in PATH. It never
